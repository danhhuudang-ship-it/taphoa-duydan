...
/**
 * Scanner mã vạch / QR dùng camera điện thoại hoặc webcam.
 * Hỗ trợ EAN, Code128, Code39, QR... — mọi format html5-qrcode hỗ trợ.
 */
